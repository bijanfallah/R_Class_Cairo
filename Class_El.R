...
hist_clim(file1, file2, file3,'JJA_daymax_hist_RCP45.pdf', title_plot='Summer Day T_2M MAX',xlim=c(20,55),max_y = 330)
...
hist_clim(file1, file2, file3,'JJA_daymin_hist_RCP45.pdf', title_plot='Summer Day T_2M MIN',xlim=c(15,40),max_y = 330)
...
hist_clim(file1, file2, file3,'DJF_daymax_hist_RCP45.pdf', title_plot='Winter Day T_2M MAX',xlim=c(5,35),max_y = 330)
...
hist_clim(file1, file2, file3,'DJF_daymin_hist_RCP45.pdf', title_plot='Winter Day T_2M MIN',xlim=c(0,25),max_y = 330)
...
trends_clim(file1, file2, file3,'Trends_DJF_daymin_RCP45.pdf', title_plot='Trends Winter Day MIN', ylim=c(6,13))
...
trends_clim(file1, file2, file3,paste0(cities[1],'_Trends_JJA_daymin_RCP45.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=1)
trends_clim(file1, file2, file3,paste0(cities[2],'_Trends_JJA_daymin_RCP45.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=2)
trends_clim(file1, file2, file3,paste0(cities[3],'_Trends_JJA_daymin_RCP45.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=3)
trends_clim(file1, file2, file3,paste0(cities[4],'_Trends_JJA_daymin_RCP45.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=4)
...
trends_clim(file1, file2, file3,paste0(cities[1],'_Trends_JJA_daymax_RCP45.pdf'), title_plot='Trends Summer Day MAX', ylim=c(30,50), city=1)
trends_clim(file1, file2, file3,paste0(cities[2],'_Trends_JJA_daymax_RCP45.pdf'), title_plot='Trends Summer Day MAX', ylim=c(20,50), city=2)
trends_clim(file1, file2, file3,paste0(cities[3],'_Trends_JJA_daymax_RCP45.pdf'), title_plot='Trends Summer Day MAX', ylim=c(30,50), city=3)
trends_clim(file1, file2, file3,paste0(cities[4],'_Trends_JJA_daymax_RCP45.pdf'), title_plot='Trends Summer Day MAX', ylim=c(30,50), city=4)
...
trends_clim(file1, file2, file3,paste0(cities[1],'_Trends_DJF_daymax_RCP45.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=1)
trends_clim(file1, file2, file3,paste0(cities[2],'_Trends_DJF_daymax_RCP45.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=2)
trends_clim(file1, file2, file3,paste0(cities[3],'_Trends_DJF_daymax_RCP45.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=3)
trends_clim(file1, file2, file3,paste0(cities[4],'_Trends_DJF_daymax_RCP45.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=4)
...
file2 <- paste0(dir,"2041_2060/T_2M_2041_2060.nc_daymin_JJA_yearmean.nc")
file3 <- paste0(dir,"2060_2089/T_2M_2070_2089.nc_daymin_JJA_yearmean.nc")
trends_clim(file1, file2, file3,paste0(cities[1],'_Trends_JJA_daymin_RCP85.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=1)
trends_clim(file1, file2, file3,paste0(cities[2],'_Trends_JJA_daymin_RCP85.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=2)
trends_clim(file1, file2, file3,paste0(cities[3],'_Trends_JJA_daymin_RCP85.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=3)
trends_clim(file1, file2, file3,paste0(cities[4],'_Trends_JJA_daymin_RCP85.pdf'), title_plot='Trends Summer Day MIN', ylim=c(20,30), city=4)
...
file2 <- paste0(dir,"2041_2060/T_2M_2041_2060.nc_daymax_JJA_yearmean.nc")
file3 <- paste0(dir,"2060_2089/T_2M_2070_2089.nc_daymax_JJA_yearmean.nc")
trends_clim(file1, file2, file3,paste0(cities[1],'_Trends_JJA_daymax_RCP85.pdf'), title_plot='Trends Summer Day MAX', ylim=c(30,50), city=1)
trends_clim(file1, file2, file3,paste0(cities[2],'_Trends_JJA_daymax_RCP85.pdf'), title_plot='Trends Summer Day MAX', ylim=c(20,50), city=2)
trends_clim(file1, file2, file3,paste0(cities[3],'_Trends_JJA_daymax_RCP85.pdf'), title_plot='Trends Summer Day MAX', ylim=c(30,50), city=3)
trends_clim(file1, file2, file3,paste0(cities[4],'_Trends_JJA_daymax_RCP85.pdf'), title_plot='Trends Summer Day MAX', ylim=c(30,50), city=4)
...
file2 <- paste0(dir,"2041_2060/T_2M_2041_2060.nc_daymax_DJF_yearmean.nc")
file3 <- paste0(dir,"2060_2089/T_2M_2070_2089.nc_daymax_DJF_yearmean.nc")
trends_clim(file1, file2, file3,paste0(cities[1],'_Trends_DJF_daymax_RCP85.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=1)
trends_clim(file1, file2, file3,paste0(cities[2],'_Trends_DJF_daymax_RCP85.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=2)
trends_clim(file1, file2, file3,paste0(cities[3],'_Trends_DJF_daymax_RCP85.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=3)
trends_clim(file1, file2, file3,paste0(cities[4],'_Trends_DJF_daymax_RCP85.pdf'), title_plot='Trends Winter Day MAX', ylim=c(10,30), city=4)
...
trends_clim(file1, file2, file3,paste0(cities[1],'_Trends_yearmean_RCP85.pdf'), title_plot='Trends Day Mean', ylim=c(10,30), city=1)
trends_clim(file1, file2, file3,paste0(cities[2],'_Trends_yearmean_RCP85.pdf'), title_plot='Trends Day Mean', ylim=c(10,30), city=2)
trends_clim(file1, file2, file3,paste0(cities[3],'_Trends_yearmean_RCP85.pdf'), title_plot='Trends Day Mean', ylim=c(10,30), city=3)
trends_clim(file1, file2, file3,paste0(cities[4],'_Trends_yearmean_RCP85.pdf'), title_plot='Trends Day Mean', ylim=c(10,30), city=4)
...
summer_days(file1, file2, file3,filename=paste0('Summer_days_RCP85.pdf'))
